...
if(Q=i.d,te&&i.p&&i.p.ii<3&&Q>7)ue=null,Z.center(null),I.style("cursor","default")
...
e.ii=i,e.x=n+i%J*(R/J),e.y=(t?1:-1)*(r*(R/J)),e.x1=e.x*A+K/2,e.y1=e.y*A+K/2,0==e.sprite.position.x&&(e.sprite.position.x=e.x1,e.sprite.position.y=e.y1),e.sprite2&&(e.sprite2.position.x=e.x*L+U/2,e.sprite2.position.y=e.y*L+U/2),e.order=1*(a-i)})})}function a(e){var t=[0,0]
